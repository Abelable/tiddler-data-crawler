const poiName = "千岛湖风景区-阳光公园";

const address = "阳光公园";
const longitude = 119.043444;
const latitude = 29.628168;

const productType = 1;
const productId = 63;

const promise = fetch("https://m.ctrip.com/restapi/soa2/16189/searchTripShootListForHomePageV2?_fxpcqlniredt=09031024215196387298&x-traceID=09031024215196387298-1749797384037-596797", {
  "headers": {
    "accept": "*/*",
